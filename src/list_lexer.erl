-file("c:/Program Files/erl6.4/lib/parsetools-2.0.12/include/leexinc.hrl", 0).
...
-file("src/list_lexer.xrl", 35).

-file("c:/Program Files/erl6.4/lib/parsetools-2.0.12/include/leexinc.hrl", 14).
...
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 91 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 93, C =< 126 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
...
yystate(5, [9|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(5, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 38 ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(5, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 91 ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(5, [C|Ics], Line, Tlen, Action, Alen) when C >= 93, C =< 126 ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
...
yystate(2, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 91 ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(2, [C|Ics], Line, Tlen, Action, Alen) when C >= 93, C =< 126 ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/list_lexer.xrl", 24).
yyaction_0(TokenChars, TokenLine) ->
     { token, { string, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("src/list_lexer.xrl", 25).
yyaction_1(TokenChars, TokenLine) ->
     { token, { ident, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/list_lexer.xrl", 26).
yyaction_2(TokenChars, TokenLine) ->
     { token, { class, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/list_lexer.xrl", 27).
yyaction_3(TokenChars, TokenLine) ->
     { token, { id, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/1}).
-file("src/list_lexer.xrl", 28).
yyaction_4(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/list_lexer.xrl", 29).
yyaction_5(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/list_lexer.xrl", 30).
yyaction_6(TokenLine) ->
     { token, { combine, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/list_lexer.xrl", 31).
yyaction_7(TokenLine) ->
     { token, { nest, TokenLine } } .

-file("c:/Program Files/erl6.4/lib/parsetools-2.0.12/include/leexinc.hrl", 282).
